...
pub1 = Publisher(name = "Золотое издевательство")
pub2 = Publisher(name = "БлэкСтарПушкин")
pub3 = Publisher(name = "ЦветныеФломастеры")
pub4 = Publisher(name = "Zewa")
pub5 = Publisher(name = "Учебная литература")
session.add(pub1)
session.add(pub2)
session.add(pub3)
session.add(pub4)
...
print(pub1,pub2,pub3,pub4,pub5)
